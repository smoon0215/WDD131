...
function renderTasks(tasks) {
  ...
  // loop through the tasks array. transform (map) each task object into
  //  the appropriate HTML to represent a to-do.
...
function taskTemplate(task){
    return `<li ${task.completed ? 'class ="strike"' : ""}>
                <p> ${task.detail}</p>
                <div>
                    <span data-action="delete">&#x274E</span>
                    <span data-action="complete">&#x2705</span>
                </div>
            </li>`;
...
// Listen for a click, call the 'newTask' function on submit and call the 'manageTasks' function if either
//  of the icons are clicked in the list of tasks.d
